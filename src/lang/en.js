export default {
  route: {
    ...
    Monitor: 'Monitor',
    TimeMonitorPoint: 'MonitorPoint',
    DomainMonitorPoint: 'MonitorPoint',
    DomainMonitorDomain: 'MonitorDomain',
    DomainMonitorIndex: 'Monitor',
    DomainSpeedTest: 'SpeedTest',
